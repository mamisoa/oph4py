...
db.define_table(
    ...
    Field("patient_firstname", "string"),
    Field("patient_birthday", "date"),
    Field("eye_side", "string"),
    Field("ascan_mode", "string"),
    Field("central_cornea_thickness", "integer"),
    Field("aqueous_depth", "double"),
    Field("lense_thickness", "double"),
    Field("axial_length", "double"),
    Field("flat_meridian", "double"),
    Field("steep_meridian", "double"),
    Field("flat_meridian_axis", "integer"),
