...
function operateFormatter(value, row, index) {
	...
	html.push(
		'<a class="edit" href="javascript:void(0)" title="Edit user"><i class="fas fa-edit"></i></a>'
	);
	...
	html.push(
		'<a class="worklist ms-2" href="javascript:void(0)" title="Worklist"><i class="fas fa-list"></i></a>'
	);
	html.push("</div>");
	return html.join("");
}
...
const operateEvents = {
	...
	"click .worklist": function (e, value, row, index) {
		UiService.showWorklistModal(row.id);
	},
...
function responseHandler(res) {
	// used if data-response-handler="responseHandler"
	list = res.items;
...
function init() {
	console.log("Initializing users_bt.js");
	...
	window.ageFormatter = ageFormatter;
