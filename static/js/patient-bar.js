...
if (patientObj["photob64"] == null) {
	...
	genderIdObj[patientObj["gender"]] == "Male"
		? document
				...
				.setAttribute(
					"src",
					HOSTURL + "/" + APP_NAME + "/static/images/assets/avatar/mini-man.svg"
				)
		: document
				.getElementById("photoId")
				.setAttribute(
					...
					HOSTURL +
						"/" +
						APP_NAME +
						"/static/images/assets/avatar/mini-woman.svg"
				);
